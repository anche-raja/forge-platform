---
id: ibatis-to-mybatis
version: 0.1.0
title: iBATIS 2 -> MyBatis 3
tier: persistence
status: detect-only
detect:
  any:
    - dependency: "org.apache.ibatis:ibatis-sqlmap"
    - file_glob: "**/sqlMapConfig.xml"
    - file_glob: "**/*SqlMap.xml"
    - import_prefix: "com.ibatis"
applies_to:
  - file_glob: "**/*SqlMap.xml"
  - selector: ibatis_daos
